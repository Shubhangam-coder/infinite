...
function preload(){
  ...
  groundImage = loadImage("runningtrack.png");
  
  cloudImage = loadImage("Clouds.png");
  
  backgroundImg = loadImage("stadium.jpg");
  
  obstacle1 = loadImage("hudle.png");
  obstacle2 = loadImage("rice.png");
...
function setup() {
 ...
 background= createSprite(0,0,600,200); background.addImage(backgroundImg);
